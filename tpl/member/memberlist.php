					...
					<tbody>
						...
						?>
							<tr class="text-c">
								...
								<td><u style="cursor:pointer" class="text-primary" onclick="member_show('<?php echo $member['nickname']; ?>','index.php?c=member&m=membershow&id=<?php echo $member['id']; ?>','10001','360','400')"><?php echo $member['nickname']; ?></u></td>
								<td><img class="avatar size-XL l" src="<?php echo $member['head_photo'] ?>"></td>
